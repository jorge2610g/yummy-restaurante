...
for(const marker of ['data-tab="inventory"','restaurant_inventory_items','restaurant_inventory_movements','saveInventoryMovement','mobile-icon-actions-v223','aria-label="Abrir menú del panel"','subscription-banner-row'])if(!panel.includes(marker))throw new Error(`panel/index.html: falta ${marker}`);
