...
for(const marker of ['professional.js?v=2528','data-tab="appointments"','data-tab="services"','data-tab="professionals"','professionalDepositRequired','professionalProviderServiceOptions'])if(!panel.includes(marker))throw new Error('panel/index.html: falta interfaz profesional '+marker);
for(const marker of ['professional_services','professional_providers','professional_provider_services','professional_availability','professional_appointments','get_professional_available_slots','create_professional_appointment','loadProfessionalAppointments','saveProfessionalSchedule','refreshProfessionalDashboard'])if(!professional.includes(marker))throw new Error('panel/professional.js: falta integración real '+marker);
