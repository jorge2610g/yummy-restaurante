...
for(const marker of ['restaurantPwaInstallBtn','install=pwa','v2.0.10'])if(!landing.includes(marker))throw new Error('index.html: falta entrada hacia PWA del panel '+marker);
