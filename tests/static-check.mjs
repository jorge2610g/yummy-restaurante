...
for(const marker of ['professional.js?v=2531','data-tab="appointments"','data-tab="services"','data-tab="professionals"','professionalPaymentMode','professionalProviderServiceOptions','professionalTimeOffModal','professionalTimeOffList','professionalRescheduleModal','professionalRescheduleSlot'])if(!panel.includes(marker))throw new Error('panel/index.html: falta interfaz profesional '+marker);
for(const marker of ['professional_services','professional_providers','professional_provider_services','professional_availability','professional_time_off','professional_appointments','get_professional_available_slots','create_professional_appointment','loadProfessionalAppointments','saveProfessionalSchedule','openProfessionalTimeOffModal','saveProfessionalTimeOff','deleteProfessionalTimeOff','openProfessionalRescheduleModal','loadProfessionalRescheduleSlots','saveProfessionalReschedule','reschedule_professional_appointment','professionalPaymentLabel','professional_booking_payment_mode','approve_professional_appointment_manual_payment','approveProfessionalManualPayment','payment_amount_due','paid_amount','refreshProfessionalDashboard'])if(!professional.includes(marker))throw new Error('panel/professional.js: falta integración real '+marker);
